...
export default function PedidoDetailPage() {
  ...
  const handleSubmit = async () => {
    ...
    console.log('[ENTREGA] Payload intentos_entrega:', JSON.stringify(intentoData, null, 2))
    ...
    return (
      <div className="space-y-4 p-4">
        <div className="animate-pulse rounded-lg border border-gray-200 bg-white p-4">
          <div className="mb-3 h-8 w-32 rounded bg-gray-200" />
    ...
    <div className="space-y-4 p-4 pb-8">
      ...
      <Card>
        <div className="space-y-3">
          ...
          <div className="border-t border-gray-100 pt-3">
            ...
            <p className="mt-0.5 text-sm text-gray-700">{currentDir}</p>
          </div>
          ...
          {currentContacto && (
            <div>
              ...
              <p className="mt-0.5 text-sm text-gray-700">{currentContacto}</p>
            </div>
          )}
          ...
          {pedido.notas && (
            <div className="rounded-md bg-yellow-50 p-3">
              ...
              <p className="mt-0.5 text-sm text-yellow-800">{pedido.notas}</p>
            </div>
          )}
      ...
      {mostrarInputClave && estado === 'en_camino' && (
        <div className="space-y-3 rounded-lg border border-gray-200 bg-white p-4">
          ...
          />
          {errorClave && (
            <p className="text-sm text-red-600">{errorClave}</p>
          )}
